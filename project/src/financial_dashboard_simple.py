...
def main():
    ...
    uploaded_file = st.file_uploader(
        ...
        type=['xlsx', 'xls'],
        help="Upload your financial data Excel file. Make sure it has columns like Date, Revenue, Expenses, Profit, etc."
    )
    ...
    if uploaded_file is not None:
        ...
        if df is not None:
            st.success(f"✅ File uploaded successfully! Loaded {len(df)} rows of data.")
        ...
        1. **Prepare your Excel file** with the following columns:
           - `Date` (required for time series charts)
        ...
        **Note:** The first row should contain column headers. The dashboard will automatically calculate additional metrics like Profit Margin and ROE.
        """)
        ...
        sample_data = {
            ...
            'Revenue': [100000, 105000, 98000],
            'Expenses': [70000, 72000, 68000],
            'Profit': [30000, 33000, 30000],
            'Cash_Flow': [25000, 28000, 26000],
            'Assets': [500000, 510000, 505000],
            'Liabilities': [200000, 205000, 202000],
            'Equity': [300000, 305000, 303000]
        }
